...
const ScoringGuide: React.FC = () => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 h-full">
      <h2 className="text-base font-semibold text-gray-700 mb-4 border-b pb-2 flex items-center">
        <InformationCircleIcon className="h-5 w-5 mr-2 text-blue-500" /> Scoring Guide & Rules
      </h2>
      <div className="space-y-4 text-xs text-gray-600">
        <div className="space-y-2">
          <p className="font-medium text-gray-700 text-xs">Gameplay:</p>
        ...
        <div className="space-y-2">
          <p className="font-medium text-gray-700 text-xs">Guess Feedback:</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li>
        ...
        <div className="space-y-2">
          <p className="font-medium text-gray-700 text-xs">Scoring per Item (Max 4 pts):</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
        ...
        <div className="space-y-2 pt-2 border-t border-gray-200">
          <p className="font-medium text-gray-700 text-xs">Final Item Score Colors:</p>
        ...
        <div className="space-y-2">
          <p className="font-medium text-gray-700 text-xs">Final Results:</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
