  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] p-6 bg-gradient-to-b from-white to-gray-100">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-3 text-gray-800">FanFrenzy</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        {/* Updated: Shuffle Mode - Now Active */}
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex flex-col items-center text-center">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Shuffle Mode</h2>
          <p className="text-gray-600 mb-6">Put iconic moments in the correct chronological order.</p>
          <Link
            href="/shuffle"
            className="w-full px-6 py-3 rounded-md text-lg font-semibold text-white bg-purple-600 hover:bg-purple-700 transition duration-300 text-center"
          >
            Start Shuffle
          </Link>
        </div>
